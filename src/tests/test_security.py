...
class TestPathTraversal:
    ...
    async def test_write_to_protected_path_rejected(self):
        ...
        assert "error" in result.lower() or "denied" in result.lower() or "permission" in result.lower() or "blocked" in result.lower()
...
class TestPolicyEnforcement:
    ...
    async def test_memory_search_is_allowed(self):
        ...
        # Use "[error]" prefix to avoid false-positives on memory content
        # that legitimately contains the word "error".
